...
Lights are object based and defined per MT_ Object to spawn with. Objects are made to be lightweight as possible to not cause any major performance impact.
